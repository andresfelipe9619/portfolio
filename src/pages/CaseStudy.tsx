              ...
              <header className="mb-16">
                <div className="flex items-center gap-3 mb-6">
                  {project.kind && (
                    <Badge
                      variant="secondary"
                      className="bg-blue-500/20 text-blue-300 border-none px-3 py-1"
                    >
                      {project.kind}
                    </Badge>
                  )}
                ...
                {project.stack && project.stack.length > 0 && (
                  <div className="mb-12">
                    <h3 className="text-sm text-white/40 uppercase tracking-widest font-semibold mb-4">
                      Tech Stack
                    </h3>
                    <div className="flex flex-wrap gap-2">
                      {project.stack.map((tech) => (
                        <Badge
                          key={tech}
                          className="bg-white/5 hover:bg-white/10 text-white/80 border-white/10 px-3 py-1.5 rounded-md"
                        >
                          {tech}
                        </Badge>
                      ))}
                  ...
                  <section>
                    ...
                    <div className="space-y-6 text-white/80 leading-relaxed text-lg">
                      {project.challenges?.map((challenge, i) => (
                        <div key={`c-${i}`}>
                          <p className="font-semibold text-white/95 mb-2">
                            Challenge:{' '}
