            ...
            <div className="min-h-[80vh] flex flex-col items-center justify-center px-6 py-24 text-center">
                ...
                <BlurFade delay={0.3}>
                    <p className="max-w-2xl text-lg text-white/60 mb-10 leading-relaxed">
                        I'm currently setting up my technical blog. Soon, I'll be sharing deep dives into
                        Software Architecture, Node.js performance, Web Scraping strategies, and Cloud Infrastructure.
                        Stay tuned!
                    </p>
                </BlurFade>
