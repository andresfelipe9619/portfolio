    ...
    <section id="skills" className="py-16 bg-gray-950 text-white">
      <div className="mx-auto max-w-5xl px-6">
        <BlurFade delay={0.25}>
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
              {t('skillsTitle', 'Technical Arsenal')}
            </h2>
            <p className="max-w-[800px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              {t(
                'skillsSubtitle',
                'A categorized view of the technologies I use to build scalable systems and beautiful interfaces.',
              )}
            </p>
          </div>
        </BlurFade>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(DATA.categorizedSkills).map(
                ...
                <Card className="h-full border-white/10 bg-white/5 hover:bg-white/10 transition-colors">
                  <CardHeader className="flex flex-row items-center gap-3 pb-2">
                    ...
                    <CardTitle className="text-lg font-medium tracking-tight">
                      {t(`skillsCategories.${category}`, category)}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
